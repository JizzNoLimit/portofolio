    ...
    <main className="relative">
      ...
      <div id="about" className="relative w-full h-full pt-24 pb-10 lg:pt-32 lg:pb-10">
        <div className="relative w-full h-full max-w-[1180px] mx-auto px-4 lg:px-10 xl:px-0 overflow-hidden">
          <div className="relative w-full lg:h-[380px] xl:h-[436px] px-8 pt-5 pb-16 lg:pb-0 lg:px-16 lg:py-10 text-center bg-secondary-bg dark:bg-secondary-bg-dark rounded-2xl xl:rounded-3xl overflow-hidden z-10">
